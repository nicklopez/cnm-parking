...
try {
	...
	$assignPlacard = new PlacardAssignment(null, $_POST["adminProfileId"], $_POST["availablePlacards"], $_POST["endDate"], $_POST["firstName"], null, $_POST["lastName"], $_POST["returnDate"], $_POST["startDate"]);
	$assignPlacard->insert($pdo);
	echo "<div class=\"alert alert-success\" role=\"alert\"><strong>Placard Assigned</strong></div>";
